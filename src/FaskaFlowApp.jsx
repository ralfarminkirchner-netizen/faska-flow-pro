...
export default function FaskaFlowApp({ onOpenArcade, onExitToHome }) {
  ...
  return (
    <div className={`min-h-screen bg-gradient-to-br ${activeFach.gradient} transition-colors duration-700 flex justify-center overflow-x-hidden relative paper-texture`}>
      ...
      {/* ── Welt-Navigation (Start / Arcade) ── */}
      <div className="fixed top-3 left-3 z-50 flex gap-2">
        {onExitToHome && (
          <button
            onClick={() => { playPop(); onExitToHome(); }}
        ...
        >
          ...
          <div className="w-full md:w-auto flex flex-col gap-4">
            ...
            <motion.button
              ...
              whileTap={{ scale: 0.98 }}
              onClick={() => { playPop(); setGameStudioOpen(true); }}
            ...
            >
              <div className="flex items-center gap-3">
                ...
                <div className="text-left">
                  <p className="font-black tracking-widest text-transparent bg-clip-text bg-gradient-to-r from-amber-400 to-pink-500 uppercase text-sm">FASKA Flow</p>
                  <p className="font-bold text-lg leading-none mt-1">Spielraum</p>
                </div>
              </div>
