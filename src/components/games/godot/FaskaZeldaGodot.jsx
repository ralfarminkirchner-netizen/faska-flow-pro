...
export default function FaskaZeldaGodot() {
  return (
    <GodotGameEmbed
      ...
      subtitle="16-Bit-Top-Down-Abenteuer mit normalem Quest-Modus, Truhen, Schluesseln, verriegelten Gates, Schwert-Combos, Schild-Counter, Dash-Slash, Bomben, mehrphasigem Bosswaechter, Sternentor und zuschaltbaren Learncade-Schreinen fuer mehrere Faecher."
