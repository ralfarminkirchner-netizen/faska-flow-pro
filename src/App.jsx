  ...
  return (
    <Suspense fallback={<LoadingFallback />}>
      <Routes>
        ...
        <Route path="/game/doom-godot" element={<FaskaDoomGodot />} />
        ...
        <Route path="/game/kart-godot" element={<FaskaKartGodot />} />
        ...
        <Route path="/game/fighter" element={<FaskaFighterSwarm />} />
        <Route path="/game/fighter-react" element={<FaskaFighterSwarm />} />
        <Route path="/game/fighter-godot" element={<FaskaFighterGodot />} />
        ...
        <Route path="/game/mansion" element={<FaskaMansionSwarm />} />
        <Route path="/game/mansion-react" element={<FaskaMansionSwarm />} />
        <Route path="/game/mansion-godot" element={<FaskaMansionGodot />} />
        <Route path="/game/rally" element={<FaskaRallySwarm />} />
        <Route path="/game/rally-react" element={<FaskaRallySwarm />} />
        <Route path="/game/rally-godot" element={<FaskaRallyGodot />} />
        <Route path="/game/arsenal" element={<FaskaArsenalSwarm />} />
        <Route path="/game/arsenal-react" element={<FaskaArsenalSwarm />} />
        <Route path="/game/arsenal-godot" element={<FaskaArsenalGodot />} />
        ...
        <Route path="/game/bomb-maze" element={<FaskaBombMazeSwarm />} />
        <Route path="/game/bomb-maze-react" element={<FaskaBombMazeSwarm />} />
        <Route path="/game/bomb-maze-godot" element={<FaskaBombMazeGodot />} />
        <Route path="/game/brawler" element={<FaskaBrawlerSwarm />} />
        <Route path="/game/brawler-react" element={<FaskaBrawlerSwarm />} />
        <Route path="/game/brawler-godot" element={<FaskaBrawlerGodot />} />
