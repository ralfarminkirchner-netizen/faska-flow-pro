...
export default function FaskaZeldaGodot() {
  return (
    <GodotGameEmbed
      ...
      subtitle="16-Bit-Top-Down-Abenteuer mit Schwert, Schild, Dash, Bomben, Bosswaechter, Sternentor und Learncade-Schreinen fuer Wortarten, Mathe, Satzbau und Lesen."
