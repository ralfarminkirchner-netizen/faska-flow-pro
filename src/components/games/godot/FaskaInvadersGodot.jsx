...
export default function FaskaInvadersGodot() {
  return (
    <GodotGameEmbed
      ...
      subtitle="Godot-4-Formation-Shooter nach Space-Invaders-/Galaga-Prinzip mit Deckungen, Wellen, Bossen, Heat, Dash, Charge-Beam, Overdrive, Powerups und Learncade-Antwortzielen."
