...
const GAMES = [
  {
    ...
    description: 'Stabile Learncade-Sammlung statt wackligem 3D-Experiment: Wort-Taxi, Lese-Labyrinth, Sortier-Dojo, Satzwerkstatt, Paar-Memory und Blitzduell mit Normalmodus, Lernmodus, Fachwahl, Wiederholung falscher Aufgaben, Zugbonus und Mastery-Fortschritt.',
    emoji: '🏰',
    category: 'Education',
  ...
  },
  {
    ...
    description: '16-Bit-Top-Down-Action-Adventure mit Raumauftraegen, Medaillen, Schwert-Combos, perfekten Rollen, Flurry-Konterfenstern, Stagger-Breaks, Finishern, Schild-Counter, Lock-on, Bogen, Bomben, Werkzeug-Siegeln, Small-Key-Toren, Bossdruck, Touchsteuerung und zuschaltbaren Learncade-Schreinen!',
    emoji: '⚔️',
    category: 'Adventure',
  ...
  },
  {
    ...
    description: 'FASKA-FLOW-Canvas-Grid-Bomber nach Bomberman-Prinzip mit Bomb-Kick, Remote-Zuendung, Dash, Kettenreaktionen, sichtbarer Blast-Vorschau, Gegnern, Fallen, Keys, Guardian, rotierenden Maze-Auftraegen, Touchsteuerung und Learncade-Antwortkacheln fuer Deutsch, Mathe, Englisch und Sachkunde!',
    emoji: '💣',
    category: 'Arcade',
  ...
  },
  {
    ...
    description: 'FASKA-FLOW-Canvas-Survival-Horror nach Resident-Evil-Prinzip mit Villa, Safe-Rooms, knapper Munition, Reload-Spannung, Fokuslicht, Gegnerzustaenden, Barrikaden, Fallen, Schluesseln, Boss-Erwachen, rotierenden Survival-Auftraegen, Exit-Ziel, Touchsteuerung und Learncade-Gates fuer Deutsch, Lesen, Mathe, Sachkunde und Englisch!',
    emoji: '🔦',
    category: 'Horror',
  ...
  },
  {
    ...
    description: 'FASKA-FLOW-Crazy-Taxi im Top-Down-Look mit Drift-Boost, Verkehr, Rivalen, Rampen, Speed-Gates, Risk-Shortcuts, Rush-Ketten, Trinkgeld-Meter, Dispatch-Zentrale, Medaillen-Vertraegen, Schichtserien-Bonus fuer saubere Fahrten, Wort-Fahrgaesten, falschen Ablieferungen, Route-Pfeil, Touchsteuerung und Learncade fuer Deutsch, Mathe, Lesen und Englisch!',
    emoji: '🚕',
    category: 'Racing',
